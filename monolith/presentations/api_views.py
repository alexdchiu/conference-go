...
def send_approval_msg(presentation_info):
    ...
    channel.basic_publish(
        ...
        body=json.dumps(presentation_info),
    )
    connection.close()


def send_rejection_msg(presentation_info):
...
def api_approve_presentation(request, pk):
    ...
    send_approval_msg(presentation_info)
...
def api_reject_presentation(request, pk):
    ...
    send_rejection_msg(presentation_info)
